    ...
    fn ui(&mut self, emulation_state: &mut crate::EmulationState, ui: &mut egui::Ui) {
        ...
        ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                ...
                show_cpuio_ports(ui, "CPU -> APU", &mut snes.bus.apu.cpuio_in);
                show_cpuio_ports(ui, "APU -> CPU", &mut snes.bus.apu.cpuio_out);
            });

            ui.checkbox(&mut snes.bus.apu.rom_enable, "ROM");
            ...
            ui.vertical(|ui| {
                egui::Grid::new("cpu-disasm").striped(true).show(ui, |ui| {
                    ...
                    for _ in 0..10 {
                        ...
                        let instruction = snes_emu::apu::disasm::disasm(pc, &snes.bus.apu);
...
impl super::Tab for ApuRamTab {
    ...
    fn ui(&mut self, emulation_state: &mut crate::EmulationState, ui: &mut egui::Ui) {
        self.memory_editor.draw_editor_contents(
            ui,
            &mut emulation_state.snes.bus.apu,
